...
export const ShareBanner = ({ userId }: { userId: string }) => {
  ...
  return (
    <div className="relative w-full inline-flex h-auto  overflow-hidden rounded-xl p-1 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
      ...
      <span className="flex gap-5 flex-col items-start h-full w-full cursor-pointer justify-start  rounded-xl bg-slate-950 px-3 py-3 text-sm font-medium text-white backdrop-blur-3xl">
        ...
        <p className="text-gray max-w-96">
          Find out right now! Copy your link, drop it in your stories or bio, and start getting
          anonymous questions from your followers.
        </p>
